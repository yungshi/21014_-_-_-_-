...
2.최간 시간과 최저 체력 소모 중 적절한 것에 선택(Speed,safety)

#관련기능
1.TSP 원순환 알고리즘
2.대사량 식 VO_2 = (0.1 × S) + (1.8 × S × G) + 35 (VO_2: 산소섭취량 S: 이동속도(m/min) G: 경사각도(%))
3.토블러의 하이킹 함수 W = 6e^(-3.5|s+0.05|)
